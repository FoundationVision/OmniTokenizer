...
from common_metrics_on_video_quality import calculate_fvd, calculate_is, calculate_lpips, calculate_psnr, calculate_ssim
...
if __name__ == "__main__":
    ...
    gen_dir = args.video_dir
    
    if args.dataset == "ucf":
        if args.split == "train":
            gt_dir = "/mnt/bn/foundation-yg1/wangjunke/UCF-101/videos_split/train"
        else:
            gt_dir = "/mnt/bn/foundation-yg1/wangjunke/UCF-101/videos_split/test"
        ...
        gt_dir = gen_dir.replace("recon", "input")
