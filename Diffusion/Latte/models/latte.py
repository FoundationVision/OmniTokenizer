...
def Latte_XL_2_omnitokenizer(**kwargs):
    return Latte(depth=28, in_channels=8, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)
...
Latte_models = {
    ...
    'Latte-S/2':  Latte_S_2,   'Latte-S/4':  Latte_S_4,   'Latte-S/8':  Latte_S_8, "Latte-XL/2-omnitokenizer": Latte_XL_2_omnitokenizer
}
